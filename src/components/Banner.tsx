        ...
        <section className="container mx-auto p-2">
            <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-4 px-20 py-10 bg-[#15161d] mt-15 rounded-2xl h-fit">
                <div className="space-y-4 md:col-span-2">
                    ...
                    <Link href={'#'} className="px-4 py-2 bg-lime-400 font-sens text-black rounded-xl hover:bg-lime-600 hover:scale-105 hover:transform hover:duration-300">BROWSE WORKOUTS</Link>
                </div>
