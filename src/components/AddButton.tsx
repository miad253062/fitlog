...
function AddButton ({clickedData}: ClickedDataProp) {
    ...
    return (
        <button className="flex items-center px-4 py-2 bg-[#ccff00] text-black rounded-2xl font-bold gap-2 cursor-pointer hover:scale-105 hover:duration-300" onClick={handleSaveLater}><MdOutlineDateRange />Add to today's plan</button>
    )
}
